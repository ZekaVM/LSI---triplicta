...
<div id="TC7.1" class="mathbox-wrapper">
  <div class="mathbox">
    $$\color{blue}{\boldsymbol{d\hspace{-0.5em}{/}\hspace{0.2em} = \vec F \cdot \vec {ds} = F_s ds}}$$
  </div>
...
<p class="jt">
Essa força pode possuir duas origens distintas: a primeira é proveniente de potenciais, por exemplo, os de interação observados entre
</p>
