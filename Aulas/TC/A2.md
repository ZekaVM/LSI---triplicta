...
<div class="toolbox">
  ...
  <div class="toolbox-header">
    ...
    <p class="toolbox-subtitle">Gás Ideal Bidimensional: Simulação, Frequência e Pressão</p>
  </div>
  <br>
  ...
  <div class="toolbox-content">
    ...
    <div class="jsbox-card" style="margin: 40px 0; border: 1px solid #d1d5da;">
      <div class="jsbox-card-header" style="background: #f1f3f5; color: #333; font-weight: bold;">
        Relação Matemática entre a Frequência de Colisão e a Pressão
      </div>
      <div class="jsbox-card-body" style="display: block; padding: 25px; background: #fff;">
        ...
        <p class="jt" style="margin-bottom: 0;">
          Assim como $k_1$, $k_2$ também é uma constante de proporcionalidade, naturalmente com unidades diferentes. Note que as dependências de $P$ e $f$ com as variáveis $T, N, L$ e $m$ são distintas! Para ver na prática o efeito de cada uma destas propriedades na frequência e na pressão, experimente utilizar a ferramenta de gráficos abaixo.
        </p>
      </div>
    </div>

    <div class="jsbox-col-title" style="font-size: 1.2em; border-bottom: 2px solid #eee; padding-bottom: 10px; margin-bottom: 20px; color: #003366;">
      2. Construindo as Curvas de Frequência e Pressão
    </div>
