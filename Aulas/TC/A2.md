...
<div class="toolbox">
  ...
  <div class="toolbox-header">
    <p class="toolbox-title">Laboratório Virtual</p>
...
### Relação entre a frequência de colisão e a pressão de um G.I.

<p class="jt">
No laboratório virtual da seção anterior, é possível visualizar como as mudanças dos valores de temperatura ($T$), lado da caixa ($L$), massa ($m$) e número das partículas ($N$) afetam a contagem final da frequência de colisão com as paredes! De forma mais exata, a relação entre a frequência $f$ e as demais variáveis pode ser dada por:
</p>

<div id="TC2.6" class="mathbox-wrapper">
  <div class="mathbox">
      $$\color{blue}{\boldsymbol{f = k_1 \frac{N}{L} \sqrt{\frac{T}{m}}}}$$
  </div>
  <div class="eq-numbers">
...
<p class="jt">
Onde $k_1$ é uma constante de proporcionalidade. Como mencionado, cada colisão com a parede está associada com uma troca de momento entre a partícula e o recipiente. Enfatizando o caso bidimensional, a relação entre pressão ($P$), frequência e as demais propriedades do sistema pode ser dada por:
</p>

<div id="TC2.7" class="mathbox-wrapper">
  <div class="mathbox">
      $$\color{blue}{\boldsymbol{P = \frac{f^2 \cdot m}{N} = k_2 \frac{N \cdot T}{L^2}}}$$
  </div>
  <div class="eq-numbers">
    <span style="font-weight: bold; color: blue;">TC2.7</span>
  </div>
</div>

<p class="jt">
Assim como $k_1$, $k_2$ também é uma constante de proporcionalidade, naturalmente com unidades diferentes. Note que as dependências de $P$ e $f$ com as variáveis $T, N, L$ e $m$ são distintas! Para ver na prática o efeito de cada uma desta propriedades na frequência e na pressão, experimente utilizar o laboratório virtual abaixo.
</p>
  

<br>
<div class="toolbox" id="lab-graficos" style="margin-top: 30px;">
  
  <div class="toolbox-header">
    <h2 class="toolbox-title">Laboratório Virtual</h2>
    <p class="toolbox-subtitle">Construindo as Curvas de Frequência e Pressão</p>
  </div>
  
  <div class="toolbox-content">
    <div class="jsbox-control-panel">
      <div class="jsbox-controls-grid" style="grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
        
        <div>
          <div class="jsbox-col-title sys">Configuração Base</div>
          
          <div class="jsbox-input-row" style="margin-bottom: 15px; background: #e9ecef; padding: 5px; border-radius: 5px;">
            <label style="font-weight: bold; color: #003366;">Eixo X:</label>
            <select id="sel-var" class="jsbox-input" style="width: 100px; font-weight: bold;">
              <option value="N">N (Número)</option>
              <option value="L">L (Lado)</option>
              <option value="T">T (Temp)</option>
              <option value="m">m (Massa)</option>
            </select>
          </div>

          <div class="jsbox-input-row"><label>N fixo:</label><input type="number" id="base-n" class="jsbox-input" value="150" disabled></div>
          <div class="jsbox-input-row"><label>L fixo:</label><input type="number" id="base-l" class="jsbox-input" value="70"></div>
          <div class="jsbox-input-row"><label>T fixo:</label><input type="number" id="base-t" class="jsbox-input" value="300"></div>
          <div class="jsbox-input-row"><label>m fixo:</label><input type="number" id="base-m" class="jsbox-input" value="50"></div>
        </div>

        <div>
          <div class="jsbox-col-title sys">Valores de Teste para <span id="lbl-var-test" style="color: #003366; font-weight: bold;">N</span></div>
          <div class="jsbox-input-row"><label>Ponto 1:</label><input type="number" id="val-1" class="jsbox-input" value="50"></div>
          <div class="jsbox-input-row"><label>Ponto 2:</label><input type="number" id="val-2" class="jsbox-input" value="100"></div>
          <div class="jsbox-input-row"><label>Ponto 3:</label><input type="number" id="val-3" class="jsbox-input" value="150"></div>
          <div class="jsbox-input-row"><label>Ponto 4:</label><input type="number" id="val-4" class="jsbox-input" value="200"></div>
          <div class="jsbox-input-row"><label>Ponto 5:</label><input type="number" id="val-5" class="jsbox-input" value="250"></div>
        </div>

        <div style="display: flex; flex-direction: column; justify-content: center;">
          <p style="font-size: 0.85em; color: #666; text-align: center; margin-bottom: 15px;">
            Preencha os 5 pontos acima e clique para calcular as equações <b>TC2.6</b> e <b>TC2.7</b>.
          </p>
          <button id="btn-plot" class="jsbox-btn jsbox-btn-primary" style="padding: 15px; font-weight: bold; font-size: 1rem;">
            GERAR GRÁFICOS
          </button>
        </div>
    ...
    <div class="jsbox-vis-layout" style="display: flex; gap: 20px; margin-top: 20px;">
      
      <div class="jsbox-vis-left" style="flex: 1; min-width: 0;">
        <div class="jsbox-card">
          <div class="jsbox-card-header" style="background: #003366;">Frequência vs <span class="lbl-eixo-x">N</span></div>
          <div class="jsbox-card-body">
            <canvas id="chart-freq" style="width: 100%; height: 250px;"></canvas>
          </div>
        </div>
      </div>
      
      <div class="jsbox-vis-right" style="flex: 1; min-width: 0;">
        <div class="jsbox-card">
          <div class="jsbox-card-header" style="background: #d9534f;">Pressão vs <span class="lbl-eixo-x">N</span></div>
          <div class="jsbox-card-body">
            <canvas id="chart-press" style="width: 100%; height: 250px;"></canvas>
          </div>
        </div>
      </div>
...
<div id="TC2.8" class="mathbox-wrapper">
  <div class="mathbox">
    $$\color{blue}{\boldsymbol{pV_m = RT}}$$
  </div>
  <div class="eq-numbers">
    <span style="font-weight: bold; color: blue;">TC2.8</span>
  </div>
</div>
