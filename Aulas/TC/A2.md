...
<p class="jt">
Dentre os diferentes sistemas possíveis, os compostos por <b>gases</b> são os mais simples. Isso decorre do fato de as moléculas que compõem os gases estarem, geralmente, muito distantes umas das outras. Essa grande distância leva a uma energia de interação intermolecular seja relativamente pequena e faz com que o volume ocupado pelas moléculas seja desprezível perto do volume total do sistema, tornando tais sistemas mais simples de serem estudados e descritos do que sistemas condensados – aqueles formados por líquidos e sólidos. Assim, gases são os primeiros sistemas que estudamos em Termodinâmica.
</p>
<p class="jt">
