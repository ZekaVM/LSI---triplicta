...
<p class="jt">
Voltando ao problema original, podemos finalmente combinar o resultado da energia cinética média total (<span style="color: blue; font-style: italic;">TC2.3</span>) com a equação obtida pelo teorema do virial (<span style="color: blue; font-style: italic;">TC2.2</span>):
</p>
