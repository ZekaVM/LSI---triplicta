  ...
  <div class="toolbox-content">
    <div class="interactive-area">
      ...
      <div class="jsbox-control-panel">
        <div class="jsbox-controls-grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));">
          
          <div>
            <div class="jsbox-col-title sys">Parâmetros do Gás</div>
            ...
            <div class="jsbox-input-row">
              <label>Massa (m):</label>
              <input type="number" id="inp-m1" class="jsbox-input" value="50" step="1">
            </div>
          </div>
          ...
          <div style="display: none;">
            ...
            <input type="number" id="inp-r1" value="0"> <input type="number" id="inp-n2" value="0">
        ...
        <div class="jsbox-vis-right">
          <div class="jsbox-card">
            <div class="jsbox-card-body" style="justify-content: center; height: 100%;">
              ...
              <svg viewBox="0 0 650 350" id="svg-freq" class="jsbox-chart" style="max-height: 350px;"></svg>
            </div>
          </div>
        </div>
